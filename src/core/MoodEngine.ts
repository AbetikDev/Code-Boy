...
export const INITIAL_STATS: Stats = { mood: 72, energy: 88, focus: 0, boredom: 0, happiness: 75, xp: 0, level: 1, craft: 0 };
...
export class MoodEngine {
  ...
  normalize(): void {
    for (const key of ['mood', 'energy', 'focus', 'boredom', 'happiness', 'craft'] as const) { this.stats[key] = clamp(this.stats[key]); }
